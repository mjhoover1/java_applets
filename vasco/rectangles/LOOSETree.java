...
public class LOOSETree extends RectangleStructure implements MaxDecompIface, LoosenessFactorIface {
	...
	/*
	 * Search for the old Rectangle. If the enclosing quadtree block of the old
	 * rectangle can still contain the NewRect, switch OldRect for NewRect and
	 * return true. No need to change the structure. Else, return false
	 */
