...
/**
 * The `DRectangle` class represents a rectangle in a 2D space. It implements
 * the `Drawable` and `ArealObject` interfaces.
 */
public class DRectangle implements Drawable, ArealObject {
	...
	/**
	 * Copy constructor, creates a new rectangle with the same values as the given
	 * one.
	 */
	...
	/**
	 * Constructor that initializes the rectangle with specified coordinates and
	 * dimensions.
	 */
