...
public class CommonApplet extends Applet implements AppletValidate, ActionListener {
	...
	try{treeType = getParameter("treetype");}catch(NullPointerException e){treeType="PM2Quadtree";}
	...
	topInterface = new TopInterface(indStructP, mp, helpArea, this);
		...
		can = new DrawingCanvas(new Rectangle(0, 0, SIZE, SIZE), 
	...
	overviewCanvas = new DrawingCanvas(new Rectangle(0, 0, SIZE, SIZE), 
					   new Rectangle(0, 0, 
							 OverviewWindow.OVERVIEW_SIZE, 
							 OverviewWindow.OVERVIEW_SIZE), 
					   createImage(OverviewWindow.OVERVIEW_SIZE, OverviewWindow.OVERVIEW_SIZE),
					   mp);
    }
