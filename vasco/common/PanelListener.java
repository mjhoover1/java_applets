...
/**
 * PanelListener is a class that implements the ContainerListener interface. It
 * is designed to resize a Panel individually for each structure based on the
...
public class PanelListener implements ContainerListener {
	...
	/**
	 * Adjusts the layout of the Panel based on the number of components in it, and
	 * triggers a global validation in the associated AppletValidate instance.
	 */
	void adjustPanel() {
	...
	/**
	 * Invoked when a component has been added to the container. Adjusts the layout
	 * of the Panel and triggers a global validation.
	 *
	...
	/**
	 * Invoked when a component has been removed from the container. Adjusts the
	 * layout of the Panel and triggers a global validation.
	 *
