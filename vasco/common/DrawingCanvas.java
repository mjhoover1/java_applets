...
public class DrawingCanvas extends Canvas implements DrawingTarget {
    ...
    public void directLine(Color c, double x1, double y1, double x2, double y2) {
        ...
        Point new1 = transPoint(x1, y1);
        Point new2 = transPoint(x2, y2);
        cur.drawLine(new1.x, new1.y, new2.x      
				, new2.y);
    }
    ...
    // Draw a thick rectangle directly using the graphics object with a specified color and thickness
    ...
    // Draw a filled rectangle directly using the graphics object with a specified color
