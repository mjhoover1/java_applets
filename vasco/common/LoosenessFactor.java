...
public class LoosenessFactor implements AdjustmentListener {
	...
	static final double logBase = 1.06;
	static final double cutOff = 1.01;
	...
	public LoosenessFactor(TopInterface ti, double initialValue, LoosenessFactorIface th) {
		...
		JScrollBar maxDChoice = new JScrollBar(Adjustable.HORIZONTAL, (int) ((initialValue)), 1, (int) (startValue),
				(int) (finishValue));
