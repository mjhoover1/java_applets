...
public class Constants {
	...
	public static int common_edge(int q1, int q2) {
		...
		if (((Constants.NW == q1) && (Constants.NE == q2)) || ((Constants.NW == q2) && (Constants.NE == q1)))
			return Constants.E;

		if (((Constants.NE == q1) && (Constants.SE == q2)) || ((Constants.NE == q2) && (Constants.SE == q1)))
			return Constants.S;

		if ((Constants.SE == q1) && (Constants.SW == q2))
			return Constants.W;
		if ((Constants.SE == q2) && (Constants.SW == q1))
			return Constants.W;

		if ((Constants.SW == q1) && (Constants.NW == q2))
			return Constants.N;
		if ((Constants.SW == q2) && (Constants.NW == q1))
			return Constants.N;
	...
	public static int reflect(int e, int q) {
		...
		if (Constants.NE == q) {
			if ((Constants.E == e) || (Constants.W == e))
				return Constants.NW;
			if ((Constants.N == e) || (Constants.S == e))
				return Constants.SE;
			return -1;
		}
	...
	public static boolean adj(int e, int q) {
		...
		if (Constants.N == e) {
			if ((Constants.NW == q) || (Constants.NE == q))
				return true;
			if ((Constants.SW == q) || (Constants.SE == q))
				return false;
			return false;
		}
