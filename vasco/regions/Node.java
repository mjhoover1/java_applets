...
public class Node {
	...
	public static int commonedge(int q1, int q2) {
		...
		if (((NW == q1) && (NE == q2)) || ((NW == q2) && (NE == q1)))
			return E;

		if (((NE == q1) && (SE == q2)) || ((NE == q2) && (SE == q1)))
			return S;
	...
	public boolean merge() {
		if ((child[0] == null) || !((child[0].isLeaf) && (child[1].isLeaf) && (child[2].isLeaf) && (child[3].isLeaf)))
			return false;

		int c = child[0].color;
		if (!((c == child[1].color) && (c == child[2].color) && (c == child[3].color)))
			return false;
